package com.curso.spring.springaspectos0001.basico;
...
public class AspectoSaludo {
    ...
    @Pointcut("execution(public void com.curso.spring.springaspectos0001.basico.ServicioSaludo.*Before())")
    ...
    public void saludoBeforeConParametro(Integer unInteger) {
        System.out.println("Mensaje de saludo before con un parámetro que vale " + unInteger);
    }
